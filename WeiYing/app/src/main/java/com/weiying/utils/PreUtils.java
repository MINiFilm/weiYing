...
import com.weiying.utils.theme.Theme;
...
public class PreUtils {
    ...
    public static Theme getCurrentTheme(Context context) {
        return com.weiying.utils.theme.Theme.valueOf(PreUtils.getString(context, "app_theme", com.weiying.utils.theme.Theme.Red.name()));
    }
